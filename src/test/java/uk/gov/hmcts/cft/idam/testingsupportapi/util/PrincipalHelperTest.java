...
class PrincipalHelperTest {
     ...
     * @see PrincipalHelper#getSessionKey(org.springframework.security.oauth2.jwt.Jwt)
     */
    @Test
    void getSessionKey_shouldReturnKeyValueIfPresent() throws Exception {
     ...
     */
    @Test
    void getSessionKey_shouldReturnDefaultValueIfKeyIsNotPresent() throws Exception {
     ...
     * @see PrincipalHelper#getClientId(org.springframework.security.oauth2.jwt.Jwt)
     */
    @Test
    void getClientId_shouldReturnFirstClientIdIfPresent() throws Exception {
     ...
     */
    @Test
    void getClientId_shouldReturnOptionalEmptyIfNoClientIdIsPresent() throws Exception {
